...
const ServicesDropdown = styled.div`
  ...
  &:before {
    ...
    border-bottom: 8px solid ${({ theme }) => theme.cardBackground};
    z-index: 2;
  }
...
const Header = memo(() => {
  ...
  const serviceItems = [
    ...
    { name: t('services.service2.title'), path: '/services#seo', icon: 'fas fa-search' },
    { name: t('services.service3.title'), path: '/services#social-media', icon: 'fas fa-share-alt' },
    { name: t('services.service4.title'), path: '/services#ppc', icon: 'fas fa-ad' },
    { name: t('services.service5.title'), path: '/services#content', icon: 'fas fa-pen-fancy' },
      ...
      <HeaderContent>
        ...
        <MobileMenu isOpen={mobileMenuOpen} ref={menuRef}>
          ...
          <MobileMenuItems>
            ...
            <MobileMenuItem active={location.pathname.includes('/services') ? 1 : 0}>
