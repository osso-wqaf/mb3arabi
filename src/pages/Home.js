        ...
        <ServicesGrid>
          {services.map((service, index) => (
            ...
            >
              ...
              <ServiceButton as={Link} to={`/services/${service.id}`}>Learn More</ServiceButton>
            </ServiceCard>
          ))}
        </ServicesGrid>
      </Section>
      ...
      <Section id="clients" style={{ background: 'rgba(49, 106, 140, 0.03)' }}>
        ...
        <ClientsSection>
          ...
          <ClientLogo data-aos="zoom-in" data-aos-delay="250" data-aos-duration="1200">
            <img src="/Copany/FB_IMG_1746479551907.jpg" alt="Company Logo" />
          </ClientLogo>
          <ClientLogo data-aos="zoom-in" data-aos-delay="300" data-aos-duration="1200">
            <img src="/Copany/Screenshot_٢٠٢٥-٠٥-٠٦-٠٠-١٢-٥١-٢٣٦_com.whatsapp.w4b[1].jpg" alt="Company Logo" />
          </ClientLogo>
          <ClientLogo data-aos="zoom-in" data-aos-delay="350" data-aos-duration="1200">
            <img src="/Copany/Screenshot_٢٠٢٥-٠٥-٠٦-٠٠-١٤-٥٨-٢٧٤_com.whatsapp.w4b.jpg" alt="Company Logo" />
          </ClientLogo>
          <ClientLogo data-aos="zoom-in" data-aos-delay="400" data-aos-duration="1200">
            <img src="/Copany/1746480054701.jpg" alt="Company Logo" />
          </ClientLogo>
          <ClientLogo data-aos="zoom-in" data-aos-delay="450" data-aos-duration="1200">
            <img src="/Copany/1746480131712.jpg" alt="Company Logo" />
          </ClientLogo>
          <ClientLogo data-aos="zoom-in" data-aos-delay="500" data-aos-duration="1200">
            <img src="/apixlogo.png" alt="Apix" />
          </ClientLogo>
        </ClientsSection>
      </Section>
